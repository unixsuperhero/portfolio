 ...
 */
export function CardForm({ value = BLANK_CARD, onSubmit, submitLabel = "Save card", actions }: CardFormProps) {
  ...
  return (
    <form className="card-form" onSubmit={submit}>
      ...
      <label>Tags — matches any<input name="tags" value={tags} placeholder="yt, slides" onChange={event => setTags(event.target.value)} /></label>
