...
export const ITEM_TYPES: readonly ItemType[] = ["document", "note", "link", "pr", "file", "dir", "task"] as const;
...
export const DOCUMENT_EXTENSIONS = [...MARKDOWN_EXTENSIONS, ".html"] as const;

export const KIND_LABELS: Record<string, string> = { document: "DOC", note: "NOTE", link: "LINK", pr: "PR", file: "FILE", dir: "DIR", task: "TASK" };
