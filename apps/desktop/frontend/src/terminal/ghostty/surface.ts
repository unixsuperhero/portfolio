...
import { SELECTION_MULTI_CLICK_INTERVAL_MS } from "../shims/selection";
import { collectWrappedTerminalLinkLine, extractTerminalLinks } from "../shims/terminalLinks";
import {
  GhosttyTerminalCore,
...
import { isMonospaceFamily } from "../shims/monospace";
...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    scrollbar.className = "ghostty-scrollbar";
    ...
    scrollbarThumb.className = "ghostty-scrollbar-thumb";
